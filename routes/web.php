...
use App\Http\Controllers\ShiprocketWebhookController;
    ...
    */
    ...
    Route::get('testgst/{gst?}',[AdminController::class,'testGST']);
...
// Socialite
    ...
    Route::get('/return-refund-policy', function () {
        return view('frontend.pages.return_refund_policy');
    })->name('return-refund-policy');
    Route::get('/exchange-policy', function () {
        return view('frontend.pages.exchange_policy');
...
// Frontend Routes
    ...
    Route::get('/get-products', [FrontendController::class, 'getProducts'])->name('get-products');
...
// Route::get('/user/chart',[AdminController::class, 'userPieChart'])->name('user.piechart');
    ...
    Route::get('/product-list/{slug}', [FrontendController::class, 'showProductList'])->name('productlist');
Route::get('/product-list/{slug}/{sub_slug}', [FrontendController::class, 'showProductList'])->name('productlist-with-sub');
...
// Coupon
    ...
    Route::post('/coupon/remove', [CouponController::class, 'couponRemove'])->name('coupon-remove');
// Payment
...
// Backend section start
    ...
    Route::post('admin/login', [FrontendController::class, 'adminLoginSubmit'])->name('admin.login.submit');
    Route::group(['prefix' => '/admin', 'middleware' => ['auth', 'admin']], function () {
        ...
        Route::resource('/post-size', 'PostSizeController');
        // Post
...
// User section start
    ...
    // get pincode & check service availability for delhivery
    Route::post('/check-availbility', [DelhiveryController::class, 'getPincode'])->middleware('user')->name('check-availbility');
    Route::POST('/check-shiping-charges', [DelhiveryController::class, 'getShippingCharges'])->middleware('user')->name('check-shiping-charges');
    Route::get('/pickupRequest', [DelhiveryController::class, 'pickupRequest'])->middleware('user')->name('pickupRequest');
    Route::get('/label-generation', [DelhiveryController::class, 'labelGeneration'])->middleware('user')->name('label-generation');
