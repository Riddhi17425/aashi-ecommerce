                    ...
                    <div class="product-info">
                        <div class="nav-main text-center mb-5">
                            ...
                            <ul class="nav nav-tabs justify-content-center" id="productTabs" role="tablist">
                                <li class="nav-item">
                                    <a class="btn filter-btn active" id="all-products-tab" data-toggle="tab"
                                        href="#all-products" role="tab">
                                        ALL PRODUCTS
                                    </a>
                                </li>
                                @php
                                ...
                                @foreach ($categories as $category)
                                    <li class="nav-item">
                                        <a class="btn filter-btn" id="category-{{ $category->id }}-tab" data-toggle="tab"
                        ...
                        <div class="tab-content" id="productTabContent">
                                            ...
                                            <div class="custom-product-card">
                                                <div class="card-media-wrap">
                                                    ...
                                                    <a href="{{ route('product-detail', $product->slug) }}"
                                                        ...
                                                        <img class="default-img" src="{{ asset('public/' . $photo[0]) }}"
                                                            alt="{{ $product->title }}">
                                                    </a>
                                                </div>
                            ...
                            @foreach ($categories as $category)
                                @php
                                    $categoryProducts = \App\Models\Product::with('getReview')
                                        ->where('status', 'active')
