                                    ...
                                    <tr id="cart-row-{{ $cart->id }}" class="cart-item-row">
                                        ...
                                        <td class="product-des" data-title="Description">
                                            <p class="product-name"><a
                                                    ...
                                                    target="_blank">{{ $cart->product['product_code'] }}@if (isset($cart->color_id) && $cart->color_id != null)
                                                        ({{ optional($cart->color)->color_name }})
                                                    @endif
                                                </a></p>
                                        ...
                                        <td class="qty" data-title="Qty">
                                            <!-- Input Order -->
                                            <div class="input-group increment_decrement" data-cart-id="{{ $cart->id }}"
                                                ...
                                                <input type="text" class="input-number qty_input" data-min="1"
                                                    data-max="100" value="{{ $cart->quantity }}" readonly>
                                        ...
                                        <td class="total-amount cart_single_price" data-title="Total"><span
                                                class="money row-total">₹{{ $cart['amount'] }}</span></td>
                            ...
                            @else
                                <tr class="empty-cart-row">
                                    <td class="text-center" colspan="7">
                                        There are no any carts available. <a href="{{ route('product-lists') }}"
                                    ...
                                    <div class="right">
                                        <ul>
                                            <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">Cart
                                                Subtotal<span
                                                    id="cart-subtotal">₹{{ number_format(Helper::totalCartPrice(), 2) }}</span>
                                            </li>
                                            ...
                                            @if ($gstTotal > 0)
                                                ...
                                                <li class="last" id="gst_amount">GST
                                                    Amount<span>₹{{ number_format($gstTotal, 2) }}</span></li>
                                            @endif
                                            <li class="last" id="order_total_price">You Pay<span
                                                    id="you-pay">₹{{ number_format($total_amount, 2) }}</span></li>
                                        </ul>
                                        <div class="button5">
                                            <a class="btn"
                                                @auth href="{{ route('checkout') }}" @else data-toggle="modal" data-target="#checkoutAuthModal" href="javascript:void(0);" @endauth>Checkout</a>
                    ...
                    <form id="checkout-auth-form">
                        ...
                        <div id="step-login" class="auth-step d-none">
                            ...
                            <div class="d-flex flex-column align-items-center gap-2 mt-4">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-4 w-100 mt-3">
...
@push('scripts')
    ...
    <script>
        ...
        window.appRoutes.cartUpdate = "{{ route('cart.update') }}";
        window.appRoutes.cartDeleteBase = "{{ url('cart-delete') }}";
