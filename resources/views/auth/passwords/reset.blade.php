                        ...
                        <div class="login-form text-center">
                            ...
                            <div class="form-group login-btn mt-4">
                                <a href="{{ route('password.request') }}"
                                   class="btn"
                                   style="width: 100%; border-radius: 0; color: #fff;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="position: relative;">
                                                ...
                                                <span onclick="togglePassword('reset_password', this)"
                                                      style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; z-index: 10; color: #666;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="position: relative;">
                                                ...
                                                <input type="password"
                                                       ...
                                                       id="reset_password_conf"
                                                       placeholder=""
                                                       required="required"
                                                       style="padding-right: 45px;">

                                                <span onclick="togglePassword('reset_password_conf', this)"
                                                      style="position: absolute; right: 15px; top: 50%; transform: translateY(-50%); cursor: pointer; z-index: 10; color: #666;">
